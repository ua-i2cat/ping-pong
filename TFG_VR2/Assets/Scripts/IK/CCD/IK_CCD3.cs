...
public class IK_CCD3: MonoBehaviour
{
    ...
    private bool offsetComputed = false;

    private Quaternion Qoffset;
    private Quaternion QoffsetINV;
    ...
    private void OnDrawGizmos()
    {
        ...
        Vector3 direction = transform.TransformDirection(Vector3.right) * 0.3f;
        Gizmos.DrawRay(transform.position, direction);

        Gizmos.color = Color.green;
        direction = transform.TransformDirection(Vector3.up) * 0.3f;
        Gizmos.DrawRay(transform.position, direction);

        Gizmos.color = Color.blue;
        direction = transform.TransformDirection(Vector3.forward) * 0.3f;
        Gizmos.DrawRay(transform.position, direction);
    }
